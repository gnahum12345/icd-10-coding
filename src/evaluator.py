...
class MetricsCalculator:
    ...
    def _global_metrics(
        ...
        # Precision: TP / (TP + FP)
        precision = true_positives / len(all_pred_codes) if len(all_pred_codes) > 0 else 0.0
    ...
    def _uncertainty_metrics(
        ...
        calibration_correlation = np.corrcoef(confidences, accuracies)[0, 1] if len(confidences) > 1 else 0.0
